Zombie RPG game that allows a single player to traverse a map and kill zombies. Weapons are placed throughout the rooms and the zombies are randomly placed in the rooms each new game.  
